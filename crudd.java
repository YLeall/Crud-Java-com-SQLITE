...
public class crudd  {
    public static void connect() {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite:desejoooo.db")) {
         ...
         do {
            ...
            if(opcao.equals("2")){
                ...
                if(op_login.equals("1")){
                    ...
                    if(existeE == false){
                        JOptionPane.showMessageDialog(null, "USUÁRIO NÃO ENCONTRADO !!", "SEUDESEJO", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
